          ...
          <div className="detail">
            ...
            <div className="hiking-flex">
              ...
              <div className="thoughtful-hiker">
                ...
                <li>
                  Familiarize yourself with hazards so you will have fun and
                  stay safe.
                </li>
                <li>
                  Stop at a visitor center, ranger station, or check the website
                  for trail and weather conditions before you go.
                </li>
