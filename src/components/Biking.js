        ...
        <div className="detail-content">
          ...
          <div className="detail biking-detail">
            ...
            <div className="biking-text">
              <h3>
                Macondo has hundreds of miles of bike paths that spread
                throughout and beyond the park.
              </h3>
              <h3>
                Paths range in difficulty from leisurely rides around the lake
                to difficult mountain biking.
              </h3>
              <h3>
                Wear a helmet, keep track of your surroundings, and bring a
                camera!
              </h3>
            </div>
          </div>
